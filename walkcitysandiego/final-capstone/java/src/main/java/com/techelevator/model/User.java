...
public class User {
	...
	private List<CheckIn> listOfCheckins;
	...
	public List<CheckIn> getListOfCheckins() {
		return listOfCheckins;
	}

	public void setListOfCheckins(List<CheckIn> listOfCheckins) {
		this.listOfCheckins = listOfCheckins;
	}
}
